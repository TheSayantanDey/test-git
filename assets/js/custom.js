(function ($) {
    ...
    function preloader() {
        ...
        let timer = dsnGrid.pageLoad(0, 100, 200, function (val) {
    ...
    var settings = {
        ...
        "data": JSON.stringify({
          "from_mail": "dipghoshraj@gmail.com",
          "subject": "hello",
          "message": "world"
        }),
      };
    ...
    const trigger = document.querySelector("menu > .trigger-sc");
    trigger.addEventListener('click', (e) => {
        e.currentTarget.parentElement.classList.toggle("open-sc");
    });
